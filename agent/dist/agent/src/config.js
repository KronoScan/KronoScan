...
export const SELLER_ADDRESS = (process.env.SELLER_ADDRESS ?? "0x0000000000000000000000000000000000000000");
...
export const USDC_ADDRESS = (process.env.USDC_ADDRESS ?? "0x3600000000000000000000000000000000000000");
...
import { resolveService } from "../../shared/ensResolver.js";
...
export async function resolveServiceConfig() {
    ...
    try {
        ...
        return {
            sellerAddress: (svc.sellerAddress || SELLER_ADDRESS),
